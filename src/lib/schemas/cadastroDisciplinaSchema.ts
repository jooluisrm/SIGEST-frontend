...
export const cadastroDisciplinaSchema = () =>
  z
    .object({
    ...
    .superRefine((data, ctx) => {
      if (
        ...
        data.dataInicio &&
        data.dataEncerramento < data.dataInicio
      ) {
        ctx.addIssue({
...
export type CadastroDisciplinaFormValues = z.infer<
  ReturnType<typeof cadastroDisciplinaSchema>
>;
