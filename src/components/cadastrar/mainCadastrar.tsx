...
export const MainCadastrar = ({ type }: Props) => {
  return (
    <main className="flex flex-col min-w-screen bg-white/60 backdrop-blur justify-center">
      <div className="relative flex bg-primaria h-15 mt-3 items-center sm:h-20">
        ...
        <h1 className="absolute left-1/2 transform -translate-x-1/2 sm:absolute sm:left-1/2 sm:transform sm:-translate-x-1/2 text-1xl sm:text-4xl text-white mx-auto">
          Cadastro {type}
        </h1>
      </div>
